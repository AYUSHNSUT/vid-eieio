...
function handleCallbackFactory(handler, config) {
    return (req, res, options = {}) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            return yield handler(req, res, Object.assign(Object.assign({}, options), { afterCallback: idTokenValidator(options.afterCallback, options.organization || config.organization) }));
        }
        catch (e) {
            throw new errors_1.HandlerError(e);
        }
    });
}
